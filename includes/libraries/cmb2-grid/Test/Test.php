...
if ( ! class_exists('\Cmb2Grid\Test\Test')) {
    class Test
    {
        ...
        {
            add_action('cmb2_init', [$this, 'testCmb']);
            add_action('cmb2_init', [$this, 'testGroupCmb']);
        }
        ...
        public function testGroupCmb()
        {
            ...
            $field1    = $cmb_group->add_field([
                'name' => __('Test Text', 'cmb2'),
                'desc' => __('field description (optional)', 'cmb2'),
                'id'   => $prefix . 'text',
                'type' => 'text',
            ]);
            $field2    = $cmb_group->add_field([
            ...
            $gField1        = $cmb_group->add_group_field($group_field_id, [
                'name' => __('Entry Title', 'cmb2'),
                'id'   => 'title',
                'type' => 'text',
            ]);
            $gField2        = $cmb_group->add_group_field($group_field_id, [
        ...
        public function testCmb()
        {
            ...
            $field2 = $cmb->add_field([
                'name' => __('Test Text Small', 'cmb2'),
                'desc' => __('field description (optional)', 'cmb2'),
                'id'   => $prefix . 'textsmall',
                'type' => 'text',
            ]);
            $field3 = $cmb->add_field([
                'name' => __('Test Text Medium', 'cmb2'),
                'desc' => __('field description (optional)', 'cmb2'),
                'id'   => $prefix . 'textmedium',
                'type' => 'text',
            ]);
            $field4 = $cmb->add_field([
                'name' => __('Website URL', 'cmb2'),
                'desc' => __('field description (optional)', 'cmb2'),
                'id'   => $prefix . 'url',
                'type' => 'text',
            ]);
            $field5 = $cmb->add_field([
            ...
            $row->addColumns([
                //$field1,
                //$field2
                [$field1, 'class' => 'col-md-8'],
                [$field2, 'class' => 'col-md-4'],
            ]);
            $row = $cmb2Grid->addRow();
            $row->addColumns([
                $field3,
