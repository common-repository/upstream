        ...
        function cmb2_grid_deactivate()
        {
            if (is_admin() && current_user_can('activate_plugins')
                ...
                add_action('admin_notices', create_function(null,
                    'echo \'<div class="error"><p>\', __( \'Activation failed: The CMB2 Grid plugin required PHP 5.3+. Please contact your webhost and ask them to upgrade the PHP version for your webhosting account.\', \'cmb2-grid\' ), \'</a></p></div>\';'));
