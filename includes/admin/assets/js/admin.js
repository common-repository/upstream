...
jQuery(document).ready(function($) {
    ...
    /* Change the text color of any invalid license messages */
    if ( $("#allex-addons-container").length ) {
        setTimeout(() => {            
            $( "#allex-addons-container .allex-addon-license-status" ).each(function( index ) {
                if ( $(this).html() != "Activated" ) {
                    $(this).css( 'color', '#dc6f8e' );
                }
            });
        }, 100);
    }
